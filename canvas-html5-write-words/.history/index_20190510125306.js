...
// window.onload = function() {
  ...
  canvas.addEventListener(touchEvent.touchstart, (event) => {
    isMouseDown = true
    let point = getPoint(event, isTouch)
  ...
  canvas.addEventListener(touchEvent.touchmove, (event) => {
    if (isMouseDown) {
      ...
      let point = getPoint(event, isTouch)
      let pos = windowToCanvas(point.x, point.y)
  ...
  function getPoint(event, isTouch) {
    if (isTouch) {
